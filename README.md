...
[![HuggingFace Hub](https://img.shields.io/badge/HuggingFace-Hub-yellow)](https://huggingface.co/akshan-main/modular-flux1-upscale)
...
blocks = ModularPipelineBlocks.from_pretrained(
    "akshan-main/modular-flux1-upscale",
